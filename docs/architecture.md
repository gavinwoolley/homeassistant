...
| `docker-compose.yml` | The server stack: Grafana, Mimir, Loki, Alloy, blackbox-exporter, cAdvisor, AdGuard Home, Mosquitto, nginx, Portainer, and more - reference only, see [Try the demo](../README.md#try-the-demo) |
