...
A self-contained Pac-Man-style maze game with pellets, power pills, frightened ghosts, score, lives, and high score.
...
In Grafana, select **Dashboards ? New ? Import dashboard**, then upload `grafana-pacman.json`. No datasource mapping is needed.

## Controls

Click to focus. Use Arrow keys or WASD to move; Space restarts. Power pills make ghosts vulnerable. AUDIO: ON/OFF is optional.
